...
import type { Immutable, Narrow, Require, Uuid } from "../../../strict/types";
...
}>, "id" | "createdByEmail" | "createdAt" | "updatedAt" | "publishedAt" | "version">, "price">;
 ...
 * a google.protobuf.FieldMask; the ones at the top level are readonly in ProductStrict.
 */
 ...
 * `(google.api.field_behavior) = OUTPUT_ONLY` and everything under one, since the
 * server owns the whole subtree. Dotted proto paths, so they can be subtracted from
 * a google.protobuf.FieldMask; the ones at the top level are readonly in CreateProductRequestStrict.
 */
 ...
 * `(google.api.field_behavior) = OUTPUT_ONLY` and everything under one, since the
 * server owns the whole subtree. Dotted proto paths, so they can be subtracted from
 * a google.protobuf.FieldMask; the ones at the top level are readonly in CreateProductResponseStrict.
 */
 ...
 * `(google.api.field_behavior) = OUTPUT_ONLY` and everything under one, since the
 * server owns the whole subtree. Dotted proto paths, so they can be subtracted from
 * a google.protobuf.FieldMask; the ones at the top level are readonly in GetProductResponseStrict.
 */
 ...
 * `(google.api.field_behavior) = OUTPUT_ONLY` and everything under one, since the
 * server owns the whole subtree. Dotted proto paths, so they can be subtracted from
 * a google.protobuf.FieldMask; the ones at the top level are readonly in UpdateProductRequestStrict.
 */
 ...
 * `(google.api.field_behavior) = OUTPUT_ONLY` and everything under one, since the
 * server owns the whole subtree. Dotted proto paths, so they can be subtracted from
 * a google.protobuf.FieldMask; the ones at the top level are readonly in UpdateProductResponseStrict.
 */
